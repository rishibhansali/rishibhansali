...
<img src="./assets/banner.svg" width="100%" alt="Rishi Bhansali — Software Engineer" />
...
#### [Sentinel](https://github.com/rishibhansali/sentinel-fraud-detection) <sub>`in progress`</sub>

Real-time fraud detection platform — deterministic scoring engine, a PostgreSQL optimization benchmark, and a WebSocket-driven case-review queue.
...
#### [Page Pilot](https://github.com/rishibhansali/page-pilot)

Chrome extension that reads a webpage and takes the actions you describe in plain English, powered by Claude.

`React` `FastAPI` `Claude API` `Supabase`
